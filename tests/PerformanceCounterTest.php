...
class PerformanceCounterTest extends TestCase
{
    ...
    #[Test] public function average_process_time_can_be_obtained_for_multiple_keys(): void
    {
    ...
    #[Test] public function a_key_can_be_cleared(): void
    {
        $this->unit->timeIterationStart($this->counterKey1);
    ...
    #[Test] public function the_counter_can_be_reset(): void
    {
        $this->unit->timeIterationStart($this->counterKey1);
